...
// Get the live chat container and input field
const liveChatContainer = document.querySelector('.live-chat-container');
const chatInput = document.querySelector('#chat-input');
const sendBtn = document.querySelector('#send-btn');
const closeChatBtn = document.querySelector('.close-chat-btn');
const messagesContainer = document.querySelector('.live-chat-messages');
const liveChatToggle = document.querySelector('.live-chat-toggle');
...
function sendMessage() {
	...
	if (message !== '') {
		// Send the message to the server (e.g. using AJAX or WebSockets)
		// For this example, we'll just add the message to the messages container
...
// Function to close the live chat
function closeChat() {
	liveChatContainer.classList.remove('active');
}

// Function to toggle the live chat
function toggleChat() {
